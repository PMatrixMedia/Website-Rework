...
/**
 * Letter Glitch background — from React Bits (DavidHDev/react-bits).
 * @see https://reactbits.dev/backgrounds/letter-glitch
 */
...
export default function LetterGlitch({
  ...
  /** Supports hex or `rgb(r,g,b)` during smooth blends */
  const colorToRgb = (c) => {
